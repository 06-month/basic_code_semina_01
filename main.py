...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr_drop_epochs', type=int, default=[20, 30, 35], nargs='+')
    ...
    dataloader_test = DataLoader(BatchManagerTinyImageNet(split='test'), shuffle=False, num_workers=10, batch_size=args.batch_size)
    ...
    for epoch in range(1, args.epochs+1):
        ...
        acc1, acc5, _, _ = val.val(model, dataloader_val, epoch=epoch)
        _, _, image_names, preds = val.val(model, dataloader_test, epoch=epoch, test=True)
